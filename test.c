...
static size_t parse_by_id(ParserState *state, size_t unmatched_checkpoint,
                          size_t id) {
  switch (id) {
  case 0:
    return parse_0(state, unmatched_checkpoint);
  default:
    return 1;
  }
}
...
static size_t group_at(ParserState *state, size_t checkpoint) {}
